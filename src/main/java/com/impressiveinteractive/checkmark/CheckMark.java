...
public final class CheckMark {
	...
	private static final MockTracker TRACKER = new MockTracker();
	...
	public static <T> T trackedMock(Class<T> cls) {
		return Mockito.mock(cls, new TrackingAnswer(TRACKER));
	}

	public static MockTester forMock(Object trackedMock) throws CheckMarkException {
		return new MockTester(TRACKER, trackedMock);
	}

	public static MethodFilter.InclusiveBuilder include(Object anything) {
		return new MethodFilter.InclusiveBuilder(TRACKER, TRACKER.extractCalledLast());
	}

	public static MethodFilter.ExclusiveBuilder exclude() {
		return new MethodFilter.ExclusiveBuilder(TRACKER, TRACKER.extractCalledLast());
	}
